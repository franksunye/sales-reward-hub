...
WECOM_CONTRACT_COMPLETION_SMARTSHEET_WEBHOOK = os.getenv(
    ...
    "https://qyapi.weixin.qq.com/cgi-bin/wedoc/smartsheet/webhook?key=7B5kfCVjtV2x6HD9yY2u971nCoiMrESCMYQKcj5xQYcYiLEPVFYMG3VvMIGQYw6Ez8JFr2DHBAbMiM44WhPJVbQcskHOOa3T0mLFBeXVZfD7"
).strip()
WECOM_PAYMENT_RECORDS_SMARTSHEET_WEBHOOK = os.getenv(
    "WECOM_PAYMENT_RECORDS_SMARTSHEET_WEBHOOK",
    "https://qyapi.weixin.qq.com/cgi-bin/wedoc/smartsheet/webhook?key=2Luk5YIz7OnXSowjQLMfWrmGPkaZpiAtvOA5VoXUA1DT3CtZMO18VkwlhNULDkw8gxCDaSvUcwaVdGOMY0xUjcY9wfBzIl4byMbL6fYBji5B"
).strip()
