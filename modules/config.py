...
WECOM_WEBHOOK_HOUSEKEEPER_OFFLINE = os.getenv(
...
WECOM_CONTRACT_COMPLETION_SMARTSHEET_WEBHOOK = os.getenv(
    "WECOM_CONTRACT_COMPLETION_SMARTSHEET_WEBHOOK",
    ""
).strip()
WECOM_PAYMENT_RECORDS_SMARTSHEET_WEBHOOK = os.getenv(
    "WECOM_PAYMENT_RECORDS_SMARTSHEET_WEBHOOK",
    ""
).strip()
WECOM_CREW_SETTLEMENT_FINANCE_LEDGER_SMARTSHEET_WEBHOOK = os.getenv(
    "WECOM_CREW_SETTLEMENT_FINANCE_LEDGER_SMARTSHEET_WEBHOOK",
    ""
).strip()
WECOM_MATERIAL_REPLENISHMENT_SMARTSHEET_WEBHOOK = os.getenv(
...
API_URL_PROJECT_SETTLEMENT_SMARTSHEET = os.getenv(
    "API_URL_PROJECT_SETTLEMENT_SMARTSHEET",
    METABASE_URL + "/api/card/2015/query"
)
API_URL_CONTRACT_COMPLETION_SMARTSHEET = os.getenv(
    "API_URL_CONTRACT_COMPLETION_SMARTSHEET",
    METABASE_URL + "/api/card/2016/query"
)
API_URL_PAYMENT_RECORDS_SMARTSHEET = os.getenv(
    "API_URL_PAYMENT_RECORDS_SMARTSHEET",
    METABASE_URL + "/api/card/2017/query"
)
API_URL_CREW_SETTLEMENT_FINANCE_LEDGER_SMARTSHEET = os.getenv(
    "API_URL_CREW_SETTLEMENT_FINANCE_LEDGER_SMARTSHEET",
    METABASE_URL + "/api/card/2015/query"
)
API_URL_MATERIAL_REPLENISHMENT_SMARTSHEET = os.getenv(
    "API_URL_MATERIAL_REPLENISHMENT_SMARTSHEET",
    METABASE_URL + "/api/card/2081/query"
)
...
API_URL_HOUSEKEEPER_OFFLINE = os.getenv(
    "API_URL_HOUSEKEEPER_OFFLINE",
    METABASE_URL + "/api/card/2085/query",
)
